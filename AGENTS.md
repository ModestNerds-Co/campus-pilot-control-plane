...
- Plan module sets must include code-owned runtime dependencies. Current hard dependencies are SIS to Academics, Academics to HR and payroll, Attendance to both Academics and SIS, Activities to both SIS and HR and payroll, Fleet to HR and payroll, Facilities to HR and payroll, Timetabling to Academics, Learning to Academics, SIS, HR and payroll, and Document Registry, Student Support to SIS, and Transport to both Fleet and SIS; the application enforces the same relationships again when authorizing operations.
