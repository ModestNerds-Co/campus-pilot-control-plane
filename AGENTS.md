...
- Plan module sets must include code-owned runtime dependencies. Current hard dependencies are SIS to Academics, Academics to HR and payroll, Fleet to HR and payroll, and Timetabling to Academics; the application enforces the same relationships again when authorizing operations.
