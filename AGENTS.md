...
- Plan module sets must include code-owned runtime dependencies. Current hard dependencies are SIS to Academics, Academics to HR and payroll, Attendance to both Academics and SIS, Fleet to HR and payroll, Timetabling to Academics, Learning to Academics, SIS, HR and payroll, and Document Registry, and Student Support to SIS; the application enforces the same relationships again when authorizing operations.
